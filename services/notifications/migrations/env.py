"""Alembic env для notifications. Шаблон тот же, что и в core."""
...
# TODO: импортировать metadata из notifications.repository.models (notification_log,
# notifications_processed_events) при появлении моделей.
